...
2. **Contributions (new since the a(17) page).**
   1. CERTIFIED — a(18) ≤ 47: the SYM16 engine's 16-chunk exhaustion of army size 48,
      NODES_TOTAL nodes, ENGINE_S s of engine time (≈ ENGINE_H core-hours; WALL_S s wall
   ...
   3. The ladder of node counts now reads 1.48·10⁹ (n = 15), 5.03·10⁹ (16), 2.15·10¹⁰
      (17), NODES_SCI (18): growth ×3.4, ×4.3, ×GROWTH per rung.

3. **Figure specs.**
   - *Update the ladder figure*: add the point n = 18 (nodes NODES_TOTAL, engine time
     ENGINE_S s) to the existing boundary-refutation cost plot (data: the chunk files
