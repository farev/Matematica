...
single-engine exhaustion — see caveats). Session 3 (2026-09-07, as a
background hedge of the good-permutations day): a(18) = 47 (CERTIFIED,
...
| 7 | **a(18) = 47** (session 3, 2026-09-07): exhaustive refutation of 48+48 by the SYM16 engine — `run_chunked.py 18 48 16 4 ./bnb_sym`, 16 resumable chunks, all UNSAT, **119,110,352,726 nodes**, 32,544 s of engine CPU time (chunks 4.6·10⁸ to 1.41·10¹⁰ nodes), 13,470 s wall on four workers niced below the day's main searches (`results/n18_m48_bnb_sym_chunk*.txt`, `results/n18_m48_run.log`; recorded bracket had been [47, 81] since 2014) + the Ainley/Kamenetsky placement from the OEIS link file, checker-verified with **47 white and 48 black** queens (`witnesses/witness_n18_m47_kamenetsky.txt`). Node growth over n = 17: ×5.55. Single-engine exhaustion, as at n = 17 (caveat below) | **CERTIFIED** |
...
python3 run_chunked.py 18 48 16 4 ./bnb_sym    # a(18) <= 47: 16 chunks, ~9 core-hours (≈ 2.5 h on 4 dedicated cores)
./check_peaceable < <(grep -v '^#' witnesses/witness_n18_m47_kamenetsky.txt)   # a(18) >= 47
```
...
- **n = 17 and n = 18 are single-engine exhaustions.** a(16) was refuted
  ...
  nodes, ~4–5 h on 4 cores at n = 17; ≈ 1.1·10¹² nodes, ~80 core-hours at
  n = 18) and remain open threads. Both verdicts rest on Lemma 6′ and the
  validation battery of NOTE §4 (16/16 agreement with the plain engine on
  the ladder and at n = 16).
- The n = 18 lower bound is the placement published in the OEIS A250000
  link file (Kamenetsky 2019, attributing the value to Ainley 1977;
  provenance secondary), verified from the definition by `check_peaceable`
  — it carries 47 white and 48 black queens, so a(18) ≥ 47 does not depend
  on any external source; no engine-found 47 + 47 witness was sought
  (the cores were busy).
