...
| First open case of the Perez-Lavin thesis conjecture confirmed: `D±(C2⊕C3^r)` attains the basic upper bound for `r ≤ 3` and first fails it at `r = 4` (`dim±(C2⊕C3⁴) = 6 < 7`, order 162) — same thesis-coverage caveat as the `C7⊕C21` row | **CERTIFIED** | NOTE §3 Result 3 |
