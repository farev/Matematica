...
and determine [PENDING: a(11)]. Every value carries a checker-verified witness
...
counted against A000055) agrees at [PENDING: list of (n, k) replicated].

## 4. n = 11

[PENDING: table of runs k = 55 … with nodes, times, workers; witness at
a(11); statement of a(11).]
