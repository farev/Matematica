...
counted against A000055) agrees at n = 7, 8 (all shapes) and on the first [PENDING] shapes of n = 9, k = 35 (each UNSAT, 1–3 min per shape).
...
**Theorem 2 (CERTIFIED, two engines for n ≤ 11).** The maximum Leech index
...
reproduces every value for n ≤ 11 [PENDING: n = 12 by the minimal engine].
