...
counted against A000055) agrees at n = 7, 8 (all shapes, both verdicts) and at n = 9, k = 35 (all 47 shapes UNSAT, 1–4 min per shape, 84 min of one core in total; `runs/sat_n9_k35_all.txt`).
