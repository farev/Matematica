...
| [**±Davenport / dissociated sets**](conjectures/pm-davenport/) | active | 1 | **CERTIFIED** — three reported-open plus–minus Davenport constants decided: **`D±(C₅⊕C₁₅) = 6`** (the single group of order ≤ 100 left as "either 6 or 7" by Marchan–Ordaz–Schmid 2013 (secondary); no dissociated 6-set among 2,324,784 candidates, three engines, identical 85,155-set census), `D±(C₇⊕C₂₁) = 8` (attains the pigeonhole bound; its extremal 7-set **unique up to automorphism** — one orbit of 2,016), `D±(C₃⊕C₄₅) = 7`; plus a census of maximum dissociated sets for **all** abelian groups of order ≤ 192 and **PROVED** superadditivity, checksum-construction and graded-counting lemmas |
