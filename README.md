...
| [**Erdős #699 (binomial common prime factors)**](conjectures/erdos-699/) | active | 1 | **CERTIFIED** — four new exceptional triples for the Erdős–Szekeres strengthening, apparently the first beyond the classical list — (2^k, 2, j) at k = 41, 67, 101, **137** (n ≈ 1.7·10⁴¹), found via a **PROVED** characterization of the exceptional families rather than search, every primality deterministic — plus a certified census (exactly 9 strict failures for all n ≤ 10⁹, none refuting #699; prior frontier 10⁷, unpublished), family decisions to m ≤ 120 / k ≤ 241 with the i=3 prime-power route empty to m = 1400, and heuristic evidence (7 of 22 semiprime exponents) that the strengthening's exceptional set is infinite |
| [**Signed difference sets**](conjectures/signed-difference-sets/) | active | 1 | **PROVED** two classical nonexistence criteria transfer to Gordon's signed difference sets, closing **45,328 of the 67,823 Open cells** of his database (zero conflicts against every known-existing cell), plus **CERTIFIED** exhaustive decisions of **58 more** — including **10 new signed difference sets with verified witnesses** (a λ=1 set in Z₅×Z₅; existence decided by group structure at orders 27, 32, 36) — dropping the Open shelf to 22,453; and a **CERTIFIED audit**: 147 of 280 stored witnesses in the published database fail its defining equation, 22 of them repaired (12 of 21 affected cells recover verified witnesses) |
