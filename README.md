...
| [**Erdős Problem 699**](conjectures/erdos-699/) | active | 1 | **CERTIFIED** — the p ≥ i statement holds for all 4 ≤ n ≤ 10⁸ (10× the public Jan-2026 frontier, first dense search past 10⁷; dual engines, independent re-verification, OEIS-anchored controls), and the complete census of p > i exceptional triples on that range is exactly the nine known ones — largest (1594324, 3, 797162) — each now carrying an independently re-verified certificate; plus **PROVED** reduction lemmas (hard rows i ≤ prime gap; Mersenne-prime criterion at i = 2) and both family digit-mechanisms |
