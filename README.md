...
| [**Triangulation discrepancy, residue class 5 mod 6 (Basti–Cremaschi 2026)**](conjectures/triangulation-discrepancy/) · [page ↗](https://fabianarevalo.com/triangulation-discrepancy) | active | 1 | **PROVED + CERTIFIED** — first attack on the open residue class of the refined polychromatic-discrepancy bound disc(T) ≤ n − 2⌈(n+2)/3⌉ (arXiv:2608.21585, open for n ≡ 5 mod 6, checked by its authors at n = 11 only): a structure theorem for any counterexample (a 4-colouring with classes ((n−1)/2, ·, ·, ·), a fully mixed big class with ≥ 2m+3 degree-3 vertices and 1..m−1 of degree ≥ 5, every other vertex on a face avoiding it), the bound **PROVED** when the big class has no vertex of degree ≥ 5, and **CERTIFIED** at the next two open orders — all 129,664,753 triangulations on 17 vertices (full census, 2,652 extremal) and all ≈ 6·10¹⁰ on 23 vertices (via the structure theorem: 948,057 candidate configurations, all of discrepancy 1) — plus the exact discrepancy distribution for 13 ≤ n ≤ 17 |
