...
| [**Strong truncations (Kardoš P4.1)**](conjectures/strong-truncations/) | active | 1 | **PROVED + CERTIFIED** — the diamond-free claw-free phrasing of Kardoš's 2025 strong-edge-coloring problem is **false**: a proved local obstruction (Balloon Lemma) and **G₁₈**, the unique smallest claw-free diamond-free cubic graph with χ′ₛ = 7 (18 vertices, DRUP-certified, counterexamples at every admissible order ≥ 18, diamonds not needed for the tight 7); census of all 36,093 quotient multigraphs to order 16 finds **χ′ₛ = 7 ⟺ balloon, exactly**, while all 556,471 truncations of *simple* cubic graphs on ≤ 20 vertices are strongly 6-edge-colorable — literature via snippets only, all cites (secondary) |
