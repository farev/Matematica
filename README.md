...
| [**Peaceable queens**](conjectures/peaceable-queens/) · [page ↗](https://fabianarevalo.com/peaceable-queens) | active | 3 | **CERTIFIED** — **a(16) = 37**, **a(17) = 42** and **a(18) = 47**: the three smallest open cases of OEIS A250000 decided (brackets [37, 64], [42, 72], [47, 81] since 2014) via exhaustive refutations of 38+38 (5.03×10⁹ nodes, two independent engines), 43+43 (2.15×10¹⁰ nodes, single engine) and 48+48 (1.19·10¹¹ nodes, ≈ 9.1 core-hours, single engine — caveats in the README) with checker-verified witnesses, from a **PROVED** line-labeling reformulation with proved pruning lemmas; plus the whole ladder a(1..15) re-derived from scratch — the first reproducible derivation artifacts for a(14) = 28 and a(15) = 32 |
