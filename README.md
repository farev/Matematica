...
| [**Grimm's conjecture**](conjectures/grimm/) | active | 1 | **CERTIFIED** — Grimm's conjecture verified for all n ≤ 10¹² (52× the 2006 Laishram–Shorey record, (secondary)), with the first census of *critical* gap members — millions of members, each factored, matched to its prime, with exact Hall margins — showing every Hall-tight gap below 10¹² is prime-power tight; plus **PROVED** margin-≤-0 gaps occur infinitely often |
