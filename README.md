...
| [**±Davenport / dissociated sets**](conjectures/pm-davenport/) | active | 1 | **CERTIFIED** — `D±(C₅⊕C₁₅) = 6`: the single group of order ≤ 100 left undetermined by Marchan–Ordaz–Schmid 2013 ("either 6 or 7", (secondary)) decided at the *lower* bracket end — no dissociated 6-set exists (2,324,784 subsets exhausted by three independent engines, identical 85,155-set extremal census) — plus `D±(C₇⊕C₂₁) = 8` (attains the pigeonhole bound; verified witness) and a census of maximum dissociated sets for **all** abelian groups of order ≤ 192, with **PROVED** checksum-construction and graded-counting lemmas |
