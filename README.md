...
| [**Reciprocal Rado numbers**](conjectures/reciprocal-rado/) | active | 1 | **CERTIFIED** — the first certified table of reciprocal Rado numbers f_r(k) for 1/x₁+⋯+1/x_k = 1/x_{k+1}: ten exact values (f₂(2..8) = 60, 40, 48, 80, 108, **150**, **192**; f₃(2) = **3276**, f₃(3) = **585**) plus f₄(2) > 60000 — sharpness of the month-old Gaiser–Ramezanpour bound 3k²+1 **fails at every computed odd prime power with shrinking excess** (Δ = 13, 5, 3 at k = 3, 5, 7), their 3·2^m theorem reproduces exactly, and new **Conjecture B** (f₂(k) = 3k² for even k ≥ 4) **predicted f₂(8) = 192 before the run** |
