...
| [**Binomial gcd (Erdős #699)**](conjectures/binomial-gcd/) | active | 1 | **CERTIFIED** — a new exceptional triple **(2⁴¹, 2, 285920731515)** for the Erdős–Szekeres p > i strengthening, the largest known (n ≈ 2.2·10¹², first new since Jan 2026, j unique, independently verified), plus **PROVED** family theorems explaining every known member (Mersenne exclusion at i=2 — the family k ∈ {4,9,11,41} lies in the semiprime exponents A085724; the i=3 mechanism = simultaneous near-primality of (3^m±1)/{2,4}), family censuses to 2⁶⁴/3⁴⁸, and independent confirmation of the known 10⁷ sweep in 30 s (prior: ~120 core-h) |
