...
| [**Erdős–Gyárfás conjecture**](conjectures/erdos-gyarfas/) · [page ↗](https://fabianarevalo.com/erdos-gyarfas) | active | 1 | **CERTIFIED** — no counterexample has ≤ 18 vertices (prior reported bound: 17; 8.3×10⁸ graphs scanned at n = 18) — *superseded 2026-09-04 by Garcia, arXiv:2609.04686: ≥ 24 vertices, DRAT-certified* — plus a {4,8}-free cubic graph on 56 vertices with only 56 sixteen-cycles from annealing in the first cubic window [54, 62] |
...
| [**Peaceable queens**](conjectures/peaceable-queens/) · [page ↗](https://fabianarevalo.com/peaceable-queens) | active | 3 | **CERTIFIED** — **a(16) = 37**, **a(17) = 42** and **a(18) = 47**: the three smallest open cases of OEIS A250000 decided (brackets [37, 64], [42, 72], [47, 81] since 2014) via exhaustive refutations of 38+38 (5.03×10⁹ nodes, two independent engines), 43+43 (2.15×10¹⁰ nodes, 29 min on 4 cores) and 48+48 (1.19×10¹¹ nodes, 9 core-hours; both single engine — caveat in the README) with checker-verified witnesses (Ainley's n = 18 placement even carries 47 + 48), from a **PROVED** line-labeling reformulation with proved pruning lemmas; plus the whole ladder a(1..15) re-derived from scratch — the first reproducible derivation artifacts for a(14) = 28 and a(15) = 32 |
...
| [**Good permutations and Mersenne primes (MO 514690)**](conjectures/good-permutations/) | active | 1 | **CERTIFIED + PROVED** — Weiss's question (Aug 2026: for odd n, does a permutation of [n] with no consecutive block of integer average exist iff n is a Mersenne prime?) settled at its first undecided case: **no good permutation of {1..63} exists** (2^57-candidate structured search, two independent engines with identical node counts 1,433,402,570, 344 s / 128 s), so the answer is "iff Mersenne prime" for all odd n ≤ 127; plus **PROVED** that Weiss's family 1, p−1, p, p−3, p−2, … is good exactly when p is prime (its odd prefix of length L sums to −p mod L, nothing else ever fails), the triangular structure theorem with the even-length lemma (only odd blocks matter), and that for m ≥ 4 no good permutation of 2^m − 1 is identity-like (a_t ≡ ±t mod 2^{m−1}) — the families the short block lengths leave alive — via a bit-string reduction and five blocks around the middle; exact counts for all n ≤ 38 (W(p) unique up to symmetry at 7 and 31) |
