...
| [**Graham rearrangement (Erdős #475)**](conjectures/graham-rearrangement/) · [page ↗](https://fabianarevalo.com/graham-rearrangement) | active | 1 | **CERTIFIED** — Graham's rearrangement conjecture closed for **every prime p ≤ 31**: all 1,346,704,310 subsets of F_p∖{0} verified via 45,590,075 dilation orbits (witness per orbit, Burnside-exact counts on all 138 cells; prior record was an uncertified 2016 check through order 25; p = 37 sweep in flight this session), and the zero-sum size-(p−3) layer — provably outside the HOS19 construction — **CERTIFIED** for all p ≤ 61 |
