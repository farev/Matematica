...
| [**Peaceable queens**](conjectures/peaceable-queens/) · [page ↗](https://fabianarevalo.com/peaceable-queens) | active | 2 | **CERTIFIED** — **a(16) = 37** and **a(17) = 42**: the two smallest open cases of OEIS A250000 decided (brackets [37, 64] and [42, 72] since 2014) via exhaustive refutations of 38+38 (5.03×10⁹ nodes, two independent engines) and 43+43 (2.15×10¹⁰ nodes, 29 min on 4 cores, single engine — caveat in the README) with checker-verified witnesses, from a **PROVED** line-labeling reformulation with proved pruning lemmas; plus the whole ladder a(1..15) re-derived from scratch — the first reproducible derivation artifacts for a(14) = 28 and a(15) = 32 |
